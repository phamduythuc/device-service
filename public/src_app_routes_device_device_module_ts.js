...
/* harmony export */ });
/* harmony import */ var D_project_device_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 1699);
...
class QRCodeComponent {
  ...
  ngOnChanges() {
    var _this = this;
    return (0,D_project_device_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
class NgxDropzoneComponent {
  ...
  extractFilesFromDirectory(directory) {
    ...
    function _getFileFromFileEntry() {
      _getFileFromFileEntry = (0,D_project_device_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (fileEntry) {
        try {
    ...
    return new Promise((resolve, reject) => {
      ...
      const readEntries = () => {
        dirReader.readEntries( /*#__PURE__*/function () {
          var _ref = (0,D_project_device_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (dirItems) {
            if (!dirItems.length) {
              resolve(files);
            } else {
